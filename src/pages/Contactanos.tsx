...
function ContactHero() {
  return <section className="border-b border-slate-100 bg-linear-to-r from-white via-[#f8f7ff] to-[#e9e4ff]"><div className="mx-auto flex min-h-[250px] w-[calc(100%-48px)] max-w-6xl items-center justify-between max-md:py-8"><div><h1 className="text-4xl font-bold tracking-[-1px] max-sm:text-3xl">Estamos aquí para ayudarte</h1><p className="mt-4 max-w-[520px] text-base leading-[1.45] text-[#5c5e70]">¿Tienes alguna pregunta, sugerencia o necesitas<br />reportar un problema? Escríbenos.</p></div><div className="relative hidden h-[130px] w-[390px] items-center justify-center overflow-hidden sm:flex"><div className="absolute h-[110px] w-[110px] rounded-full border border-[#bda3f1]" /><div className="absolute h-20 w-[270px] rotate-[-12deg] rounded-[50%] border border-[#bda3f1]" /><div className="flex h-20 w-20 items-center justify-center rounded-full bg-white p-5 shadow-[0_4px_20px_rgba(61,68,218,0.18)]"><img className="h-10 w-10 object-contain" src="/Logo.svg" alt="" aria-hidden="true" /></div><span className="absolute right-4 rounded border-2 border-[#6842dd] px-5 py-3 text-3xl text-[#6842dd]">✉</span></div></div></section>;
}
