    ...
    <aside className="h-fit rounded-lg border border-slate-200 bg-white p-3">
      ...
      <div className="mt-3 overflow-hidden rounded-md border border-slate-100">
        ...
        <div className="px-3 pb-3">
          ...
          <p className="mt-3 text-sm font-medium">⌖ Ubicación {value.show_location ? 'visible' : 'oculta'}</p>
          <p className="mt-1 text-sm text-[#676878]">Distrito, Provincia</p>
          <div className="mt-3 rounded bg-[#f0edff] p-3 text-xs text-[#6040b5]">ⓘ Tu correo electrónico no se muestra públicamente.</div>
        </div>
      </div>
    </aside>
  );
